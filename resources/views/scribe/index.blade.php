...
<head>
    ...
    <title>FONDEXUS API Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                    <ul id="tocify-header-fondexus-api-documentation" class="tocify-header">
                <li class="tocify-item level-1" data-unique="fondexus-api-documentation">
                    <a href="#fondexus-api-documentation">FONDEXUS API Documentation</a>
                </li>
                                    <ul id="tocify-subheader-fondexus-api-documentation" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="caracteristicas">
                                <a href="#caracteristicas">Características</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="uso">
                                <a href="#uso">Uso</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<div class="page-wrapper">
    ...
    <div class="content">
        <h1 id="fondexus-api-documentation">FONDEXUS API Documentation</h1>
<aside>
    <strong>Base URL</strong>: <code>http://localhost</code>
</aside>
<p>La API de FONDEXUS proporciona acceso programático al Sistema Integrado de Gestión Interna de FONDESCOL. Esta documentación le guía en el uso de los endpoints disponibles para interactuar con la plataforma.</p>
...
<ul>
<li><strong>Gestión de Usuarios</strong>: Operaciones CRUD completas para la administración de usuarios</li>
<li><strong>Autenticación</strong>: Soporte para autenticación mediante tokens</li>
<li><strong>Seguridad</strong>: Implementación de middlewares de seguridad y validación</li>
</ul>
<h2 id="uso">Uso</h2>
<p>Para usar la API, incluya el token de autenticación en el header <code>Authorization</code> con el formato <code>Bearer {token}</code>.</p>
